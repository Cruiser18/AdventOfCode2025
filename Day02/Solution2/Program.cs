...
// Calculate the sum of all invalid IDs (Part 2: repeated at least twice)
long result = InvalidIdFinderAdvanced.SumInvalidIds(input);

Console.WriteLine($"Sum of all invalid IDs (Part 2): {result}");
